function dA_rooted_tree = rooted_tree_from_connected_graph(A_tree, root_node_id)
    % Turns an undirected tree and a root node into a rooted tree
    ...
    [~,parent_node_id_from_node_id] = graphtraverse(A_tree, root_node_id, 'Method', 'BFS', 'Directed', false) ;  % NB: pred(root_node_id)==0
