function result = is_a_mj2_and_target_missing(input_file_path, input_root_path, output_root_path, varargin)
    is_true_so_far = does_file_name_end_in_dot_mj2(input_file_path) ;
    if ~is_true_so_far ,
        result = false ;
        return
    end
