function is_all_well = find_and_verify(root_folder_path, file_name_regexp, verify_function, varargin)
    tic_id = tic() ;
    verified_ok_count = 0 ;
    ...
    if isempty(problem_paths) ,
        fprintf(['All files with names matching the regexp "%s" in folder \n' ...
                 '    %s\n' ...
...
function [verified_ok_count, problem_paths] = ...
    ...
    for i = 1 : raw_tiles_input_entity_count ,
        ...
        if is_this_file_a_folder ,
            ...
            if does_match_regexp(file_name, file_name_regexp)  ,
