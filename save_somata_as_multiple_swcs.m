function save_somata_as_multiple_swcs(file_names_or_file_name_template, somata_xyzs, names_or_name_template, color)
    ...
    for soma_index = 1 : soma_count ,
        ...
        save_somata_as_single_swc(file_name, soma_xyz, name, color) ;
    end
end
