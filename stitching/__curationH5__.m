...
backupfolder = fullfile(h5folder,sprintf('%s/backup',sample));
% folder list
...
if reply== 'Y' | reply=='y'
    ...
    % update h5 filelist
    unix(sprintf('rm %s',fullfile(h5folder,sprintf('%s/classifier_output',sample),'listh5files')));
