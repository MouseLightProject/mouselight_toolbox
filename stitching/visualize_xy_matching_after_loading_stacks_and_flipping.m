function visualize_xy_matching_after_loading_stacks_and_flipping(...
    ...
    % Get the stack shape, needed by util.correctTiles() below
    ...
    central_tile_landmarks_ijk = util.correctTiles(flipped_central_tile_landmarks_ijk, stack_shape_ijk) ;  % flip dimensions
    ...
    other_tile_landmarks_ijk = util.correctTiles(flipped_other_tile_landmarks_ijk, stack_shape_ijk) ;
